...
router.post('/', (0, auth_1.default)(user_constants_1.USER_ROLE.dealer, user_constants_1.USER_ROLE.user), subscription_controller_1.subscriptionController.createSubscription);
router.patch('/:id', (0, auth_1.default)(user_constants_1.USER_ROLE.dealer), subscription_controller_1.subscriptionController.updateSubscription);
router.delete('/:id', (0, auth_1.default)(user_constants_1.USER_ROLE.admin), subscription_controller_1.subscriptionController.deleteSubscription);
